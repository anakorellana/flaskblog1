...
class Migrate(object):
    ...
    def __init__(self, path='./migrations2', host=None, port=None, user=None, password=None, database=None,
...
def main(*args):
    ...
    migration_path = os.path.join(os.getcwd(), "migrations2")
...
""")
    ...
    parser.add_argument("-m", dest="message",
                        help="message description for migrations2 created with the \"create\" command")
    ...
    parser.add_argument("--path", default=migration_path,
                        help="path to the migration folder either absolute or relative to the "
                             "current directory. (default: \"./migrations2\")")
