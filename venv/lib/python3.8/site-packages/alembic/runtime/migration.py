...
class MigrationContext(object):
    ...
    def autocommit_block(self):
        ...
        .. warning::
            ...
            unconditionally committed**.  This means that the run of migrations2
            preceding the operation will be committed, before the overall
            migration operation is complete.

            It is recommended that when an application includes migrations2 with
            ...
            migrations2 whether or not one of them has an autocommit block.
    ...
    def begin_transaction(self, _per_migration=False):
        ...
        the outer "transaction" for a series of migrations2 begins.  Example::
