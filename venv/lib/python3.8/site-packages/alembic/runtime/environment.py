...
class EnvironmentContext(util.ModuleClsProxy):
    ...
    ``with:`` statement.  A typical use of :class:`.EnvironmentContext`::
        ...
        config = Config()
        config.set_main_option("script_location", "myapp:migrations2")
    ...
    def is_offline_mode(self):
        """Return True if the current migrations2 environment
    ...
    def configure(
        ...
        **kw
        ...
        :param transaction_per_migration: if True, nest each migration script
         in a transaction rather than the full series of migrations2 to
         run.
        ...
        :param render_as_batch: if True, commands which alter elements
         ...
         directive, so that batch migrations2 will take place.
        ...
        :param mssql_batch_separator: The "batch separator" which will
         ...
         migrations2.  Defaults to ``GO``.  Note this is in addition to the
        ...
        :param oracle_batch_separator: The "batch separator" which will
         ...
         Oracle migrations2.  Defaults to ``/``.  Oracle doesn't add a
    ...
    def run_migrations(self, **kw):
        """Run migrations2 as determined by the current command line
        configuration
