...
class Operations(util.ModuleClsProxy):
    ...
    migrations2 by passing in a :class:`.MigrationContext`::
    ...
    def batch_alter_table(
        ...
        """Invoke a series of per-table migrations2 in batch.
        ...
        migrations2 include operations not supported by SQLite's ALTER TABLE,
