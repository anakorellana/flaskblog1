...
names will change, which can impact the behavior of database migrations2.
...
migrations2 in a staging environment when changing this value to ensure that the
    ...
    def _check_max_identifier_length(self, connection):
        if self._get_effective_compat_server_version_info(connection) >= (
            ...
            util.warn(
                ...
                "database migrations2 as dynamically generated names may "
